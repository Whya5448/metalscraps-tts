package dev.whya.tts.providers
...
fun createResponseError(response: Response, vararg string: String): dev.whya.tts.core.Response {
    response.run {
        ...
        return dev.whya.tts.core.Response.error(builder.toString())
    }
}